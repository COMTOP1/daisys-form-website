  ...
  if (!availableDates || availableDates.length < 1) {
    return (
      <div className="flex min-h-screen items-center justify-center font-sans baseColour">
        <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-12 px-8 sm:items-start mainColour">
          <Image
            src={"/cheese-and-wine-logo.png"}
            alt={"default logo"}
          ...
          <h1 className="text-3xl font-semibold mb-6">
            Book a Cheese &amp; Wine night table
          </h1>
          <p className="underline">
            Unfortunately there are no available Cheese &amp; Wine nights to
            book
          </p>
          <p>
            Please check back later for another available Cheese &amp; Wine
            night
          </p>
          <div></div>
        </main>
